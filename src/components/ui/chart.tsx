                ...
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    ...
                    <div className={cn("flex flex-1 justify-between leading-none", nestLabel ? "items-end" : "items-center")}>
                      ...
                      {item.value && <span className="font-mono font-medium tabular-nums text-foreground">{Number(item.value).toLocaleString()}</span>}
                    </div>
                  </>
                )}
              </div>
...
function getPayloadConfigFromPayload(config: Record<string, any>, payload: Record<string, any>, key: string) {
