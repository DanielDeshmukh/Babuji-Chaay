...
const PrintReceipt = ({
  ...
  const shopAddress =
    "Shop no. 7, K.D. Empire, Mira Road (E), Thane - 401107";
      ...
      <div className="receipt-safe-wrapper">
        <div className="controls-card-new">
          <div className="controls-header">
            ...
            <p style={{ margin: "0 0 20px 0", color: "#666" }}>
              Bill #{String(data?.billNo)} is ready.
            </p>
          </div>
        ...
        >
          <div className="receipt">
            ...
            <div className="center x-small-text">
              Tel: {shopPhone}
            </div>
            ...
            <div className="row x-small-text">
              <span>Bill No: {String(data?.billNo)}</span>
              <span>{String(data?.date ?? "").split(",")[1] || ""}</span>
            </div>
            <div className="row x-small-text">
              <span>Date: {String(data?.date ?? "").split(",")[0] || ""}</span>
            ...
            <div className="row small-text">
              <span>SUBTOTAL</span>
              <span>{String(data?.subtotal || "0.00")}</span>
            </div>

            {!isRefund && Number(data?.discount) > 0 && (
              <div className="row small-text">
                <span>DISCOUNT</span>
            ...
            <div className="row bold medium-text">
              <span>
                {isRefund ? "REFUND TOTAL" : "NET AMOUNT"}
              </span>
              <span>INR {String(data?.total || "0.00")}</span>
            </div>
            <div className="separator-double" />
